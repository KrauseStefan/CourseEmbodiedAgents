...
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		dp.setTravelSpeed(8);
		LineFollower lineFol = new LineFollower(btwCenter, bwsLeft, dp);
...
//		TrackNavigator navigator = new TrackNavigator(dp, lineMapPoseProvider);
		NXT_Moonwalker program = new NXT_Moonwalker(dp, solarPanelDetector, clawController, lineFol, bwsLeft, bwsRight);
